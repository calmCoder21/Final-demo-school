...
export default function SignupPage() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (!verify.ok) throw new Error(verifyData.error || "Captcha failed");
  ...
  return (
    <div className="p-10 max-w-md mx-auto space-y-4">
      ...
      <input type="text" placeholder="Full Name" className="border p-2 w-full" onChange={(e) => setFullName(e.target.value)} />
      ...
      <button onClick={handleSignup} disabled={loading} className="bg-black text-white px-4 py-2 w-full">
